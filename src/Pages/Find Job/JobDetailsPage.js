...
const JobDetailsPage = () => {
  ...
  return (
    <div className="container mx-auto my-2 py-8 bg-white mt-3 rounded-sm">
      ...
      <div className="text-lg mb-6">Job Description: {job.jobDescription}</div>

      <div className=" bg-orange-400 rounded-lg shadow-md p-4">
